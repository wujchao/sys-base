...
// SysSettingColumns defines and stores column names for table sys_setting.
type SysSettingColumns struct {
	...
	Type         string // 1系统内置2否
	Status       string // 状态1启用2禁用
	SortList     string // 排序
	CreatedAt    string //
	UpdatedAt    string //
}

// sysSettingColumns holds the columns for table sys_setting.
